...
function beforeOffer(peerConnection) {
    ...
    const interval = setInterval(() => {
        ...
        context.lineWidth = 1;
        let gradient = context.createLinearGradient(0, 150, 100, 0)
        gradient.addColorStop(0, "#8f6B29");
        gradient.addColorStop(0.5, "#FDE08D");
        gradient.addColorStop(1.0, "#DF9F28");
        context.fillStyle = gradient;
        context.textAlign = 'center';
        context.save();
        context.translate(width / 3, height - 70);
